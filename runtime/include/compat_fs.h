...
enum compat_fs_slot {
    ...
    COMPAT_FS_EOF = 6,
    COMPAT_FS_ERROR = 7,
    COMPAT_FS_CLEAR_ERROR = 8,
    COMPAT_FS_REMOVE = 9,
    COMPAT_FS_RENAME = 10,
    COMPAT_FS_CHDIR = 11,
    COMPAT_FS_MKDIR = 12,
    COMPAT_FS_RMDIR = 13,
    COMPAT_FS_GET_FILE_NUMBER = 14,
    COMPAT_FS_FIND_FIRST = 15,
    COMPAT_FS_FIND_NEXT = 16,
    COMPAT_FS_FIND_CLOSE = 17,
    COMPAT_FS_DISK_INFO = 18,
    COMPAT_FS_GETCWD = 19,
    COMPAT_FS_GETCWD2 = 20,
    COMPAT_FS_STAT = 21,
    COMPAT_FS_INIT = 22,
    COMPAT_FS_FORMAT = 23,
    COMPAT_FS_REFRESH_CACHE = 24,
    COMPAT_FS_READ_CLUSTER = 25,
    COMPAT_FS_ABS_READ = 26,
    COMPAT_FS_ACCESS = 27,
    COMPAT_FS_UPDATE = 28,
    COMPAT_FS_FLUSH_CACHE = 29
};
